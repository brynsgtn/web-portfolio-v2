  ...
  return (
    <div className="border border-red-500 ">
      ...
      <div>
        ...
        <button className="btn border-primary-content text-primary-content mt-5 ml-5 hover:text-base-100 hover:bg-primary-content transition-colors duration-300 bg-transparent">
          Resume
        </button>
      </div>
    </div>
